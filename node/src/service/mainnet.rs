...
use sc_service::{
	error::Error as ServiceError, Arc, Configuration, TaskManager, TransactionPool, WarpSyncParams,
};
...
use crate::{
	cli::Cli,
	rpc::FullDeps,
	runtime::{opaque::Block, AccountId, Balance, Index},
};
...
> {
	...
	Ok(sc_service::PartialComponents {
		...
		select_chain,
		transaction_pool,
		other: (telemetry, grandpa_block_import, grandpa_link),
	})
}
