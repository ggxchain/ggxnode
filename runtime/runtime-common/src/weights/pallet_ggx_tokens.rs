...
//! Autogenerated weights for pallet_ggx_tokens
//!
...
/// Weights for pallet_ggx_tokens using the Substrate node and recommended hardware.
pub struct WeightInfo<T>(PhantomData<T>);

impl<T: frame_system::Config> pallet_ggx_tokens::WeightInfo for WeightInfo<T> {
