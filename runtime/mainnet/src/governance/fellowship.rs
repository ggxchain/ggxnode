...
parameter_types! {
	...
	pub storage UndecidingTimeout: BlockNumber = 7 * Days::get();
}
...
impl pallet_referenda::TracksInfo<Balance, BlockNumber> for TracksInfo {
	...
	fn tracks() -> &'static [(Self::Id, pallet_referenda::TrackInfo<Balance, BlockNumber>)] {
		static DATA: Lazy<[(u16, pallet_referenda::TrackInfo<Balance, BlockNumber>); 10]> =
			Lazy::new(|| {
				[
					(
						0u16,
